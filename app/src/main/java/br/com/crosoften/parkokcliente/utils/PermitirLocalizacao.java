...
public class PermitirLocalizacao {
    ...
    public static void requestPermission(MapFragment mapFragment, int requestId,
                                         String permission, boolean finishActivity) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(mapFragment.getActivity(), permission)) {
            PermitirLocalizacao.RationaleDialog.newInstance(requestId, finishActivity)
                    .show(mapFragment.getFragmentManager(), "dialog");
        } else {
            ActivityCompat.requestPermissions(mapFragment.getActivity(), new String[]{permission}, requestId);
